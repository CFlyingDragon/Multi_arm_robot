...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'unknown_surface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/d/catkin_ws/src/robot_description/unknown_surface/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT unknown_surface_NUM_DUMMY_TARGETS)
      set(unknown_surface_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::unknown_surface::wrapped-linker-option${unknown_surface_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR unknown_surface_NUM_DUMMY_TARGETS "${unknown_surface_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::unknown_surface::wrapped-linker-option${unknown_surface_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND unknown_surface_LIBRARIES "${interface_target_name}")
