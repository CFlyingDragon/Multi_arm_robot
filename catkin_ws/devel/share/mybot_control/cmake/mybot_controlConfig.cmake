...
if("TRUE" STREQUAL "TRUE")
  set(mybot_control_SOURCE_PREFIX /home/d/catkin_ws/src/robot_gazebo/Gazebo-MultiRobot-base/src/mybot_control)
  set(mybot_control_DEVEL_PREFIX /home/d/catkin_ws/devel)
  ...
  set(mybot_control_INSTALL_PREFIX /home/d/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/d/catkin_ws/src/robot_gazebo/Gazebo-MultiRobot-base/src/mybot_control/${idir}'.  ${_report}")
    endif()
