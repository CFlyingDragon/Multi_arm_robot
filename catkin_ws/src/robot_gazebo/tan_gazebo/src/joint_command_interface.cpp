...
int resetFlag =0;
void jointCommandCallback(const std_msgs::Float64MultiArrayConstPtr& jointCommandMsg)
{
    joint1.data = jointCommandMsg->data[0];
    joint2.data = jointCommandMsg->data[1];
    joint3.data = jointCommandMsg->data[2];
    joint4.data = jointCommandMsg->data[3];
    joint5.data = jointCommandMsg->data[4];
    joint6.data = jointCommandMsg->data[5];
    joint7.data = jointCommandMsg->data[6];
