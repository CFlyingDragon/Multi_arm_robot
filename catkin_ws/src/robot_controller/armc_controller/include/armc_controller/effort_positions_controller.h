...
#ifndef EFFORT_POSITIONS_CONTROLLER_H
#define EFFORT_POSITIONS_CONTROLLER_H
 ...
 */
class EffortPositionsController : public controller_interface::Controller<hardware_interface::EffortJointInterface>
{  
public:
  EffortPositionsController();
  ~EffortPositionsController();
