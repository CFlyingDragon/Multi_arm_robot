...
# Form implementation generated from reading ui file 'armct_form3.ui'
#
...
class Ui_ArmctForm3(object):
    def setupUi(self, ArmctForm3):
        ArmctForm3.setObjectName("ArmctForm3")
        ArmctForm3.resize(1238, 903)
        ArmctForm3.setIconSize(QtCore.QSize(16, 16))
        ArmctForm3.setAnimated(False)
        self.centralwidget = QtWidgets.QWidget(ArmctForm3)
        ...
        self.lineEdit_qq_armt.setGeometry(QtCore.QRect(80, 190, 401, 41))
        ...
        self.button_plan_data.setGeometry(QtCore.QRect(20, 120, 211, 61))
        ...
        self.button_plan_home.setGeometry(QtCore.QRect(20, 190, 211, 61))
        ...
        ArmctForm3.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ArmctForm3)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1238, 31))
        self.menubar.setDefaultUp(False)
        self.menubar.setObjectName("menubar")
        ArmctForm3.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ArmctForm3)
        self.statusbar.setObjectName("statusbar")
        ArmctForm3.setStatusBar(self.statusbar)

        self.retranslateUi(ArmctForm3)
        QtCore.QMetaObject.connectSlotsByName(ArmctForm3)

    def retranslateUi(self, ArmctForm3):
        _translate = QtCore.QCoreApplication.translate
        ArmctForm3.setWindowTitle(_translate("ArmctForm3", "MainWindow"))
        self.label.setText(_translate("ArmctForm3", "运行内容显示框"))
        self.label_15.setText(_translate("ArmctForm3", "进度："))
        self.button_refresh.setText(_translate("ArmctForm3", "刷新选择按钮"))
        self.button_read.setText(_translate("ArmctForm3", "读取数据"))
        self.lineEdit_qq_armt.setText(_translate("ArmctForm3", "/home/d/catkin_ws/src/robot_python/data/robots/armct/armt_position.txt"))
        self.label_32.setText(_translate("ArmctForm3", "qq_armc:"))
        self.lineEdit_qq_armc.setText(_translate("ArmctForm3", "/home/d/catkin_ws/src/robot_python/data/robots/armct/armc_position.txt"))
        self.label_31.setText(_translate("ArmctForm3", "qq_armt:"))
        self.lineEdit_f_armt.setText(_translate("ArmctForm3", "/home/d/catkin_ws/src/robot_python/data/robots/armct/armt_force.txt"))
        self.lineEdit_f_armc.setText(_translate("ArmctForm3", "/home/d/catkin_ws/src/robot_python/data/robots/armct/armc_force.txt"))
        self.label_33.setText(_translate("ArmctForm3", "f_armt:"))
        self.label_34.setText(_translate("ArmctForm3", "f_armc:"))
        self.label_19.setText(_translate("ArmctForm3", "读取数据栏"))
        self.label_3.setText(_translate("ArmctForm3", "规划数据并切换"))
        self.button_plan_init.setText(_translate("ArmctForm3", "起始段规划"))
        self.button_plan_data.setText(_translate("ArmctForm3", "运行数据轨迹"))
        self.button_plan_home.setText(_translate("ArmctForm3", "返回段规划"))
        self.label_18.setText(_translate("ArmctForm3", "选择操作的机械臂"))
        self.radioButton_robot1.setText(_translate("ArmctForm3", "armt"))
        self.radioButton_robot2.setText(_translate("ArmctForm3", "armc"))
        self.radioButton_all.setText(_translate("ArmctForm3", "all"))
        self.button_begin.setText(_translate("ArmctForm3", "开始"))
        self.button_stop.setText(_translate("ArmctForm3", "停止"))
        self.checkBox_real.setText(_translate("ArmctForm3", "实物勾    仿真默认"))
        self.checkBox_force.setText(_translate("ArmctForm3", "六维力勾    位置默认"))
        self.button_receive.setText(_translate("ArmctForm3", "接收机器人状态"))
